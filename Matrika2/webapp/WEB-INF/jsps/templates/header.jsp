...
<jerry:insertResource type="script" resource="/js/jquery.js" />
<jerry:insertResource type="script" resource="/js/superfish.js" />
			...
			<tbody>
				<tr>
					<td width="27%" valign="middle"><img
						src="<c:url value="/images/banner-top_01.gif" />" width="210" height="75" /></td>
					<td width="14%" valign="top"><img
						src="<c:url value="/images/banner-top_02.gif" />" width="252" height="75" /></td>
					<td width="59%" valign="bottom">
					<table width="150" border="0" align="right" cellpadding="0"
						cellspacing="0">
						<tr valign="top">
							<td width="10" valign="middle"><img
								src="<c:url value="/images/ico-login.gif" />" width="10" height="11" /></td>
							<td width="33%" valign="middle"><span class="matrikalinksml">
							<a href="<c:url value="/Login.html" />" class="matrikalinksml">Login</a>
							</span></td>
							<td width="10%" valign="middle"><matrika:img
								src="/images/ico-sitemap.gif" width="13"
								height="13" /></td>
							<td width="47%" height="7" valign="middle"><a
								href="<c:url value="/SiteMap.html" />" class="matrikalinksml">Site
							Map</a></td>
						</tr>
					</table>
					</td>
