...
<%@ taglib uri="/WEB-INF/matrika.tld" prefix="matrika"%>
    ...
    <div class="center">
        <img src="<c:url value="/images/motherhood2.jpg" />" width="370" height="398" /><br />
    </div>
    ...
    <br />
    <div class="center">
        <img src="<c:url value="/images/motherhood3.jpg" />" width="370" height="275" /><br />
    </div>
    <h2>
    ...
    <br />
    <div class="center">
        <img src="<c:url value="/images/caesarean.jpg" />" width="347" height="227" /><br />
        <br />
        <img src="<c:url value="/images/Caesarean-Birth.jpg" />" width="349" height="241" />
        <br />
    </div>
