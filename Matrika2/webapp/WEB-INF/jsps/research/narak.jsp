...
<%@ taglib uri="/WEB-INF/matrika.tld" prefix="matrika"%>
    ...
    <div align="left" class="default">
        ...
        <p align="center">
            <img src="<c:url value="/images/mapping-session.gif" />" width="380" height="290" />
            <br />
    ...
    <div align="left">
        <p align="center">
            <img src="<c:url value="/images/rajasthani-ritual.gif" />" width="380" height="298" />
            <br />
    ...
    <div align="left">
        <p align="center" class="default">
            <img src="<c:url value="/images/bemata-tri-loka.gif" />" width="380" height="466" />
            <br />
        ...
        <p align="center" class="default">
            <img src="<c:url value="/images/Bemata-on-charpoy-leg.gif" />" width="379" height="278" />
            <br />
